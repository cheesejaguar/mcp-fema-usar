...
class USARUser(BaseModel):
    ...
    security_clearance: SecurityClearance = Field(..., description="Security clearance level")
    task_force_id: Optional[str] = Field(None, description="Task force assignment")
    agency: str = Field(..., description="Employing agency")
    badge_number: Optional[str] = Field(None, description="Badge/ID number")
    piv_card_id: Optional[str] = Field(None, description="PIV card identifier")
    ...
    last_training: Optional[datetime] = Field(None, description="Last training date")
...
class SecurityConfig:
    ...
    def _get_secret_key(self) -> str:
        ...
        if not secret:
            ...
            logger.warning("Using generated JWT secret key - set JWT_SECRET environment variable")
        return secret
    ...
    def _get_encryption_key(self) -> bytes:
        ...
        if key:
            ...
            logger.warning("Using generated encryption key - set ENCRYPTION_KEY environment variable")
            return key
    ...
    def _initialize_permissions(self) -> Dict[USARRole, List[str]]:
        ...
        return {
            USARRole.TASK_FORCE_LEADER: [
                ...
                "personnel:manage", "resources:manage", "reports:create",
                "communications:manage", "safety:override"
            ],
            USARRole.DEPUTY_TF_LEADER: [
                "command:read", "operations:manage", "planning:manage",
                "logistics:manage", "search:*", "rescue:*", "medical:*",
                "personnel:manage", "resources:manage", "reports:create"
            ],
            USARRole.SAFETY_OFFICER: [
                "safety:*", "personnel:read", "operations:read",
                "hazmat:*", "environmental:*", "reports:create",
                "communications:read", "emergency:declare"
            ],
            USARRole.OPERATIONS_CHIEF: [
                "operations:*", "search:*", "rescue:*", "medical:manage",
                "personnel:manage", "resources:manage", "tactical:*",
                "communications:manage"
            ],
            USARRole.PLANNING_CHIEF: [
                "planning:*", "reports:*", "documentation:*",
                "intelligence:*", "maps:*", "weather:read",
                "resources:read", "personnel:read"
            ],
            ...
            USARRole.SEARCH_TEAM_MANAGER: [
                "search:*", "personnel:read", "equipment:read",
                "maps:read", "communications:read", "reports:create"
            ],
            USARRole.RESCUE_TEAM_MANAGER: [
                "rescue:*", "personnel:read", "equipment:read",
                "structural:read", "communications:read", "reports:create"
            ],
            USARRole.MEDICAL_TEAM_MANAGER: [
                "medical:*", "triage:*", "supplies:medical",
                "personnel:read", "communications:read", "reports:create"
            ],
            USARRole.TECHNICAL_SPECIALIST: [
                "technical:*", "structural:*", "hazmat:read",
                "communications:technical", "reports:create"
            ],
            USARRole.TEAM_MEMBER: [
                "operations:read", "personnel:read", "equipment:read",
                "communications:read", "safety:read"
            ],
            USARRole.SUPPORT_PERSONNEL: [
                "logistics:read", "supplies:read", "facilities:read",
                "communications:read"
            ],
            USARRole.OBSERVER: [
                "read:*"
