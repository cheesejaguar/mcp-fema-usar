...
def safety_officer_monitor(
    ...
    try:
        ...
        if safety_data.get("hazard_monitoring", {}).get("operational_hazards", {}).get("level") == "MEDIUM":
        ...
        return json.dumps({
            ...
            "status": "success",
            "data": safety_data,
            "recommendations": recommendations or ["Continue current safety protocols"]
        }, indent=2)
    ...
    try:
        ...
        if accountability_type in ["assignments", "full"]:
            accountability_data["position_assignments"] = {
                "task_force_leader": {"assigned": "John Smith", "status": "operational"},
                "safety_officer": {"assigned": "Sarah Johnson", "status": "operational"},
                "search_team_manager": {"assigned": "Mike Brown", "status": "operational"},
                "rescue_team_manager": {"assigned": "Lisa Davis", "status": "operational"},
                "medical_team_manager": {"assigned": "Dr. Wilson", "status": "operational"}
            }
        ...
        return json.dumps({
            ...
            "alerts": [] if accountability_data["personnel_accounted"] == 70 else ["Missing personnel detected"]
        }, indent=2)
...
def mission_assignment_tracker(
    ...
    try:
        ...
        if priority_filter:
            filtered_missions = [m for m in filtered_missions if m["priority"] == priority_filter]
...
def external_coordination(
    coordination_type: Literal["incident_command", "mutual_aid", "federal_agencies", "all"] = "all",
    ...
    try:
        coordination_data = {
            ...
            } if communication_status else None
        }
        ...
        return json.dumps({
            ...
            "communication_check": "All systems operational" if communication_status else "Status not checked"
        }, indent=2)
